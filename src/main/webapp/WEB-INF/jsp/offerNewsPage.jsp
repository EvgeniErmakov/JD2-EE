...
<div class="registrationDiv" style="width: 50%; margin: 0 auto; text-align: center;">
    <h2 style="font-weight: 600;">${offer_news}</h2>
    <form action="Controller" method="post">
   ...
   justify-content: center;    align-items: center;   margin-right: 20px;
    margin-left: 20px; font-size: 20px;   justify-content: space-between; width: 150px;height:50px"><c:out value="${offer_news}"/></button>
    </form>
</div>
</body>
</html>
